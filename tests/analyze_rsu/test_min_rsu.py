...
from rsuanalyzer.analyze_rsu.min_rsu import (_calc_min_rsu_for_specific_theta,
                                             calc_min_rsu_for_thetas)
...
def test_calc_min_rsu_for_specific_theta_case1(
    ...
    mocker.patch(
        "rsuanalyzer.analyze_rsu.min_rsu.calc_rsu", 
...
def test_calc_min_rsu_for_thetas(
    ...
    mocker.patch(
        "rsuanalyzer.analyze_rsu.min_rsu._calc_min_rsu_for_specific_theta", 
